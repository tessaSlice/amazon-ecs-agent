...
func GPUMetricToGeneralMetricsWrapper(m types.GPUMetric) *ecstcs.GeneralMetricsWrapper {
...
func GPUMetricsToInstancePayload(metrics []types.GPUMetric, usageTotal int64) []*ecstcs.GeneralMetricsWrapper {
	if len(metrics) == 0 {
		return nil
	}
...
func GPUMetricsForContainer(metrics []types.GPUMetric, gpuDeviceIDs []string) []*ecstcs.GeneralMetricsWrapper {
